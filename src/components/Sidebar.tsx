  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-surface-container-low z-40 flex flex-col justify-between border-r border-outline-variant/30 select-none">
      <div className="flex flex-col">
        ...
        <div id="sidebar-brand-header" className="h-14 px-4 flex items-center justify-between border-b border-outline-variant/25 bg-surface-container-lowest">
          <span className="font-bold text-[15px] tracking-tight text-on-surface">
            Enjin Sentry
          </span>
